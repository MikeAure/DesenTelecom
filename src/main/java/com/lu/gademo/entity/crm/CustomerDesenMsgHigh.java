...
@Setter
@Entity
@Table(name = "customer_desen_msg_high", schema = "crm")
public class CustomerDesenMsgHigh {
    @Id
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CustomerDesenMsgHigh)) return false;
        CustomerDesenMsgHigh that = (CustomerDesenMsgHigh) o;
