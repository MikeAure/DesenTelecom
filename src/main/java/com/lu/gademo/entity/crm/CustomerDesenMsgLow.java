...
@Setter
@Entity
@Table(name = "customer_desen_msg_low", schema = "crm")
public class CustomerDesenMsgLow {
    @Id
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CustomerDesenMsgLow)) return false;
        CustomerDesenMsgLow that = (CustomerDesenMsgLow) o;
