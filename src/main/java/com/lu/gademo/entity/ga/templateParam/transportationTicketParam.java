...
@Entity
@Table(name = "transportationticket_param")
public class transportationTicketParam extends BaseEntity {
    ...
    public transportationTicketParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        transportationTicketParam param = new ObjectMapper().readValue(json, transportationTicketParam.class);
        this.id = param.id;
    ...
    public transportationTicketParam() {
    }
