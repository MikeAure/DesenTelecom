...
@Entity
@Table(name = "onlinemovie" + "_param")
public class onlineMovieParam extends BaseEntity {
    ...
    public onlineMovieParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        onlineMovieParam param = new ObjectMapper().readValue(json, onlineMovieParam.class);
        this.id = param.id;
