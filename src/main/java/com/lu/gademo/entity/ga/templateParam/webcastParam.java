...
@Entity
@Table(name = "webcast" + "_param")
public class webcastParam extends BaseEntity {
    ...
    public webcastParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        webcastParam param = new ObjectMapper().readValue(json, webcastParam.class);
        this.id = param.id;
