...
@Entity
@Table(name = "onlineshopping_param")
public class onlineShoppingParam extends BaseEntity {
    ...
    public onlineShoppingParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        onlineShoppingParam param = new ObjectMapper().readValue(json, onlineShoppingParam.class);
        this.id = param.id;
