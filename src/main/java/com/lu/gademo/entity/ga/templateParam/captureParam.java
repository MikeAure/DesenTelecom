...
@Entity
@Table(name = "capture" + "_param")
public class captureParam extends BaseEntity {
    ...
    public captureParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        captureParam param = new ObjectMapper().readValue(json, captureParam.class);
        this.id = param.id;
