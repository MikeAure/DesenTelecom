...
@Entity
@Table(name = "telecommunication" + "_param")
public class telecommunicationParam extends BaseEntity {
    ...
    public telecommunicationParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        telecommunicationParam param = new ObjectMapper().readValue(json, telecommunicationParam.class);
        this.id = param.id;
