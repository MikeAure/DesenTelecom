...
@Entity
@Table(name = "marry_param")
public class marryParam extends BaseEntity {
    ...
    public marryParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        marryParam param = new ObjectMapper().readValue(json, marryParam.class);
        this.id = param.id;
