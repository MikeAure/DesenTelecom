...
@Entity
@Table(name = "game" + "_param")
public class gameParam extends BaseEntity {
    ...
    public gameParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        gameParam param = new ObjectMapper().readValue(json, gameParam.class);
        this.id = param.id;
