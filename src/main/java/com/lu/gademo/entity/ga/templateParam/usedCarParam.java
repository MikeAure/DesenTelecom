...
@Entity
@Table(name = "usedcar" + "_param")
public class usedCarParam extends BaseEntity {
    ...
    public usedCarParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        usedCarParam param = new ObjectMapper().readValue(json, usedCarParam.class);
        this.id = param.id;
