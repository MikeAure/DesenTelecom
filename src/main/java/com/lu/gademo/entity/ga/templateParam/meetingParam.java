...
@Entity
@Table(name = "meeting" + "_param")
public class meetingParam extends BaseEntity {
    ...
    public meetingParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        meetingParam param = new ObjectMapper().readValue(json, meetingParam.class);
        this.id = param.id;
