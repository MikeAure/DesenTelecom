...
@Entity
@Table(name = "investment" + "_param")
public class investmentParam extends BaseEntity {
    ...
    public investmentParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        investmentParam param = new ObjectMapper().readValue(json, investmentParam.class);
        this.id = param.id;
