...
@Entity
@Table(name = "locallife" + "_param")
public class localLifeParam extends BaseEntity {
    ...
    public localLifeParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        localLifeParam param = new ObjectMapper().readValue(json, localLifeParam.class);
        this.id = param.id;
