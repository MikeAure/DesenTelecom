...
@Entity
@Table(name = "usecar" + "_param")
public class useCarParam extends BaseEntity {
    ...
    public useCarParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        useCarParam param = new ObjectMapper().readValue(json, useCarParam.class);
        this.id = param.id;
