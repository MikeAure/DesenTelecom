...
@Entity
@Table(name = "rec_rule_alg")
public class RecRuleAlg {
    @Id
    ...
    @Basic
    @Column(name = "conforcheckalg")
    private Integer conforcheckAlg;
    @Basic
    @Column(name = "conforcheckparam")
    private Integer conforcheckParam;
    ...
    public Integer getConforcheckAlg() {
        return conforcheckAlg;
    }

    public void setConforcheckAlg(Integer conforcheckAlg) {
        this.conforcheckAlg = conforcheckAlg;
    }

    public Integer getConforcheckParam() {
        return conforcheckParam;
    }

    public void setConforcheckParam(Integer conforcheckParam) {
        this.conforcheckParam = conforcheckParam;
    }
