...
@Entity
@Table(name="onlinelending" + "_param")
public class onlineLendingParam extends BaseEntity {
    ...
    public onlineLendingParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        onlineLendingParam param = new ObjectMapper().readValue(json, onlineLendingParam.class);
        this.id = param.id;
