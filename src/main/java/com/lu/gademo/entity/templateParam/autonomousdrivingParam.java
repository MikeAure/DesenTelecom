...
@Entity
@Table(name = "autonomousdriving_param")
public class autonomousdrivingParam extends BaseEntity {
    ...
    public autonomousdrivingParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        autonomousdrivingParam param = new ObjectMapper().readValue(json, autonomousdrivingParam.class);
        this.id = param.id;
