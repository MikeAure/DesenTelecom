...
@Entity
@Table(name="express_param")
public class expressParam extends BaseEntity {
    ...
    public expressParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        expressParam param = new ObjectMapper().readValue(json, expressParam.class);
        this.id = param.id;
