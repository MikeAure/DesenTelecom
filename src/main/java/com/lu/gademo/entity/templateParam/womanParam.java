...
@Entity
@Table(name="woman" + "_param")
public class womanParam extends BaseEntity {
    ...
    public womanParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        womanParam param = new ObjectMapper().readValue(json, womanParam.class);
        this.id = param.id;
