...
@Entity
@Table(name="networkaccess" + "_param")
public class networkaccessParam extends BaseEntity {
    ...
    public networkaccessParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        networkaccessParam param = new ObjectMapper().readValue(json, networkaccessParam.class);
        this.id = param.id;
