...
@Entity
@Table(name="house" + "_param")
public class houseParam extends BaseEntity {
    ...
    public houseParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        houseParam param = new ObjectMapper().readValue(json, houseParam.class);
        this.id = param.id;
