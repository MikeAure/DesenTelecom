...
@Entity
@Table(name="browser" + "_param")
public class browserParam extends BaseEntity {
    ...
    public browserParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        browserParam param = new ObjectMapper().readValue(json, browserParam.class);
        this.id = param.id;
