...
@Entity
@Table(name="onlinevoting" + "_param")
public class onlinevotingParam extends BaseEntity {
    ...
    public onlinevotingParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        onlinevotingParam param = new ObjectMapper().readValue(json, onlinevotingParam.class);
        this.id = param.id;
