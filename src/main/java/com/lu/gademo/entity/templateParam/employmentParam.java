...
@Entity
@Table(name = "employment" + "_param")
public class employmentParam extends BaseEntity {
    ...
    public employmentParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        employmentParam param = new ObjectMapper().readValue(json, employmentParam.class);
        this.id = param.id;
