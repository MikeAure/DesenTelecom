...
@Entity
@Table(name="customerservice_param")
public class customerserviceParam extends BaseEntity {
    ...
    public customerserviceParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        customerserviceParam param = new ObjectMapper().readValue(json, customerserviceParam.class);
        this.id = param.id;
