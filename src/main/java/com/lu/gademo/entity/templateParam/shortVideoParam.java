...
@Entity
@Table(name = "shortvideo" + "_param")
public class shortVideoParam extends BaseEntity {
    ...
    public shortVideoParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        shortVideoParam param = new ObjectMapper().readValue(json, shortVideoParam.class);
        this.id = param.id;
