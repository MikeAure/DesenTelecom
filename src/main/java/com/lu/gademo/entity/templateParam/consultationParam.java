...
@Entity
@Table(name="consultation" + "_param")
public class consultationParam extends BaseEntity {
    ...
    public consultationParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        consultationParam param = new ObjectMapper().readValue(json, consultationParam.class);
        this.id = param.id;
