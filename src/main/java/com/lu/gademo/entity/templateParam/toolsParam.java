...
@Entity
@Table(name="tools" + "_param")
public class toolsParam extends BaseEntity {
    ...
    public toolsParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        toolsParam param = new ObjectMapper().readValue(json, toolsParam.class);
        this.id = param.id;
