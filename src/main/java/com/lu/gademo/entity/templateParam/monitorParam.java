...
@Entity
@Table(name="monitor_param")
public class monitorParam extends BaseEntity {
    ...
    public monitorParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        monitorParam param = new ObjectMapper().readValue(json, monitorParam.class);
        this.id = param.id;
