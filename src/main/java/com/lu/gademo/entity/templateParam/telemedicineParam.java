...
public class telemedicineParam extends BaseEntity {
    ...
    public telemedicineParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        telemedicineParam param = new ObjectMapper().readValue(json, telemedicineParam.class);
        this.id = param.id;
