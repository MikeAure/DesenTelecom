...
@Entity
@Table(name = "security" + "_param")
public class securityParam extends BaseEntity {
    ...
    public securityParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        securityParam param = new ObjectMapper().readValue(json, securityParam.class);
        this.id = param.id;
