...
@Entity
@Table(name = "travel" + "_param")
public class travelParam extends BaseEntity {
    ...
    public travelParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        travelParam param = new ObjectMapper().readValue(json, travelParam.class);
        this.id = param.id;
