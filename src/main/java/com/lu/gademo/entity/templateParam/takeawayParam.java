...
@Entity
@Table(name="takeaway_param")
public class takeawayParam extends BaseEntity {
    ...
    public takeawayParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        takeawayParam param = new ObjectMapper().readValue(json, takeawayParam.class);
        this.id = param.id;
