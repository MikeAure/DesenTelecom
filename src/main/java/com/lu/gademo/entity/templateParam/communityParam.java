...
@Entity
@Table(name = "community_param")
public class communityParam extends BaseEntity {
    ...
    public communityParam(String json) throws IOException {
//        System.out.println("json数据："+json);
        communityParam param = new ObjectMapper().readValue(json, communityParam.class);
        this.id = param.id;
