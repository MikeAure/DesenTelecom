...
public class AlgorithmsFactory {
    ...
    public void init() {
        ...
        algorithmInfoMap.put("floor", new AlgorithmInfo("floor", 9, AlgorithmType.GENERALIZATION, 2, null, this.generalization));
        algorithmInfoMap.put("valueMapping", new AlgorithmInfo("valueMapping", 10, AlgorithmType.REPLACEMENT, 4, null, this.replacement));
        algorithmInfoMap.put("truncation", new AlgorithmInfo("truncation", 11, AlgorithmType.GENERALIZATION, 1, null, this.generalization));
        algorithmInfoMap.put("floorTime", new AlgorithmInfo("floorTime", 12, AlgorithmType.GENERALIZATION, 3, null, this.generalization));
        algorithmInfoMap.put("suppressEmail", new AlgorithmInfo("suppressEmail", 13, AlgorithmType.REPLACEMENT, 8, null, this.replacement));
        algorithmInfoMap.put("addressHide", new AlgorithmInfo("addressHide", 14, AlgorithmType.GENERALIZATION, 4, null, this.generalization));
        algorithmInfoMap.put("nameHide", new AlgorithmInfo("nameHide", 15, AlgorithmType.REPLACEMENT, 6, null, this.replacement));
        algorithmInfoMap.put("numberHide", new AlgorithmInfo("numberHide", 16, AlgorithmType.REPLACEMENT, 7, null, this.replacement));
        algorithmInfoMap.put("SHA512", new AlgorithmInfo("SHA512", 17, AlgorithmType.REPLACEMENT, 3, null, this.replacement));
        ...
        algorithmInfoMap.put("passReplace", new AlgorithmInfo("passReplace", 19, AlgorithmType.REPLACEMENT, 5, null, this.replacement));
        algorithmInfoMap.put("value_hide", new AlgorithmInfo("value_hide", 20, AlgorithmType.REPLACEMENT, 1, null, this.replacement));
        algorithmInfoMap.put("suppressAllIp", new AlgorithmInfo("suppressAllIp", 21, AlgorithmType.REPLACEMENT, 9, null, this.replacement));
        algorithmInfoMap.put("suppressIpRandomParts", new AlgorithmInfo("suppressIpRandomParts", 22, AlgorithmType.REPLACEMENT, 10, null, this.replacement));
