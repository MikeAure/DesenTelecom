...
public class DesenInfoStringBuilders {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(desenInfoPreIden, desenInfoAfterIden, desenIntention, desenRequirements, desenControlSet, desenAlgParam, desenLevel, desenAlg, dataType);
    }
