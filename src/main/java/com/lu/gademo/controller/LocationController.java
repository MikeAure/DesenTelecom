...
//        return CommandExecutor.openExe(cmd);
        ...
        DSObject result = this.generalization.service(dsObject, 6, Integer.valueOf(id),
                Double.valueOf(time));
...
//        return CommandExecutor.openExe(cmd);
        List<String> rawData = Arrays.asList(points.split(";"));
        DSObject dsObject = new DSObject(position, rawData);
        DSObject result = this.generalization.service(dsObject, 7, Integer.valueOf(id),
                Double.valueOf(time));
        return result.getList().stream().map(Object::toString).collect(Collectors.toList());
...
//        return CommandExecutor.openExe(cmd);
        ...
        DSObject result = this.anonymity.service(dsObject, 2, Integer.valueOf(k), Double.valueOf(s_cd), Double.valueOf(rho));
        return result.getList().stream().map(Object::toString).collect(Collectors.toList());
    }
...
//        return CommandExecutor.openExe(cmd);
        DSObject dsObject = new DSObject(position);
        DSObject result = anonymity.service(dsObject, 3, Integer.valueOf(k), Integer.valueOf(s_cd));
        return result.getList().stream().map(Object::toString).collect(Collectors.toList());
    }
...
//        return CommandExecutor.openExe(cmd);
        ...
        DSObject result = anonymity.service(dsObject, 4, Integer.valueOf(k));
        return result.getList().stream().map(Object::toString).collect(Collectors.toList());
    }
...
//        return CommandExecutor.openExe(cmd);
        DSObject dsObject = new DSObject(rawData);
        DSObject result = anonymity.service(dsObject, 5, Integer.valueOf(op));
        return result.getList().stream().map(Object::toString).collect(Collectors.toList());
    }
...
//        return CommandExecutor.openExe(cmd);
        DSObject dsObject = new DSObject(rawData);
        DSObject result = anonymity.service(dsObject, 6, Integer.valueOf(k));
        return result.getList().stream().map(Object::toString).collect(Collectors.toList());
    }
...
//        return CommandExecutor.openExe(cmd);
        DSObject dsObject = new DSObject(rawData);
        DSObject result = anonymity.service(dsObject, 11, Integer.valueOf(k));
        return result.getList().stream().map(Object::toString).collect(Collectors.toList());
    }
...
//        return CommandExecutor.openExe(cmd);
        ...
        dsObject.setString(rawData);
        DSObject result = anonymity.service(dsObject, 12, Integer.valueOf(k));
        return result.getList().stream().map(Object::toString).collect(Collectors.toList());
    }
}
