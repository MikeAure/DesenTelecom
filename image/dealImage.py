...
if __name__ == '__main__':
    ...
    parser.add_argument("algName", type=str, 
                        choices=["pixelate", "pixelate_region", "gaussian_blur", 
                                 "gaussian_blur_region", "box_blur", "box_blur_region", 
                                 "replace", "replace_region", "image_add_color_offset",
                                 "image_exchange_channel", "meanValueImage"])
    ...
    rectangle_range = [(100, 100, 200, 200), (50, 50, 300, 300), (25, 25, 400, 400)][args.param]
